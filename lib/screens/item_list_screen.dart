        ...
        actions: [
          IconButton(
            onPressed: () {
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => const RestoreListScreen()),
              );
            },
            ...
            itemBuilder: (context, index) {
              ...
              return Dismissible(
                ...
                confirmDismiss: (direction) async {
                  return await showDialog<bool>(
                    ...
                    builder: (context) => AlertDialog(
                      ...
                      content: Text('Voulez-vous supprimer la liste "${list.name}" ?'),
                      actions: [
                        TextButton(
                ...
                onDismissed: (direction) async {
                  await FirestoreService().deleteBuyList(list.id!);
